...
<head>
  ...
  <style>
    ...
    .start-btn, .payment-btn { background: #00ffcc; color: #000; padding: 8px 14px; border-radius: 6px; text-decoration: none; font-weight: bold; transition: background 0.3s; display:inline-block; margin-top:10px; font-size:0.9em; }
    .start-btn:hover, .payment-btn:hover { background: #00e6b2; }
                ...
                <div class="course-card">
                    ...
                    <div class="course-info">
                        ...
                        <?php elseif ($kursus['status_pendaftaran'] == 'Aktif'): ?>
                            <a href="../materi_kursus.php?id_kelas=<?= $kursus['id_kelas']; ?>" class="start-btn">Mulai Belajar</a>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endforeach; ?>
